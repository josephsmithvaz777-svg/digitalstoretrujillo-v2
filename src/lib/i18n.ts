...
export const TRANSLATIONS = {
    en: {
        ...
        pay_success_title: 'Payment Submitted!',
        pay_success_desc: 'We will verify your payment and send your products to your email within 5-10 minutes.',
    ...
    es: {
        ...
        pay_success_title: '¡Pago Enviado!',
        pay_success_desc: 'Verificaremos tu pago y enviaremos tus productos a tu correo en 5-10 minutos.',
