...
export const TRANSLATIONS = {
    en: {
        ...
        pay_yape_how_to_pay: 'How to pay',
        ...
        pay_yape_scan_me: 'Scan Me',
        pay_yape_number: 'Yape Number',
        pay_yape_account_holder: 'Account Holder',
        pay_yape_amount: 'Amount to Pay',
        pay_yape_screenshot: 'Payment Screenshot',
        pay_yape_click_upload: 'Click to upload',
        pay_yape_remove: 'Remove',
        pay_yape_reference: 'Security Code (3 digits)',
    ...
    es: {
        ...
        pay_yape_how_to_pay: 'Cómo pagar',
        ...
        pay_yape_scan_me: 'Escanéame',
        pay_yape_number: 'Número Yape',
        pay_yape_account_holder: 'Titular de la Cuenta',
        pay_yape_amount: 'Monto a Pagar',
        pay_yape_screenshot: 'Captura de Pago',
        pay_yape_click_upload: 'Clic para subir',
        pay_yape_remove: 'Eliminar',
        pay_yape_reference: 'Código de Seguridad (3 dígitos)',
